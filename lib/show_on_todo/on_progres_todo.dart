...
class InProgresDetailsPage extends StatefulWidget {
  final TodoItem todoItem;

  const InProgresDetailsPage({
    Key? key,
    required this.todoItem,
  }) : super(key: key);

  @override
  _InProgresDetailsPageState createState() => _InProgresDetailsPageState();
}

class _InProgresDetailsPageState extends State<InProgresDetailsPage> {
