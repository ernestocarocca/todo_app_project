...
class InDoneDetailsPage extends StatefulWidget {
  final TodoItem todoItem;

  const InDoneDetailsPage({
    Key? key,
    required this.todoItem,
  }) : super(key: key);

  @override
  _InDoneDetailsPageState createState() => _InDoneDetailsPageState();
}

class _InDoneDetailsPageState extends State<InDoneDetailsPage> {
